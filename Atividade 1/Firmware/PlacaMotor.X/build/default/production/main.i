...
# 52 "C:/Program Files (x86)/Microchip/MPLABX/v5.35/packs/Microchip/PIC18Fxxxx_DFP/1.2.26/xc8\pic\include\proc\pic18f4550.h"
...
{
adx = adc_read(0);
tempo = (1833.0*adx)/1023.0;
tempo = 2000.0-tempo;
tempo *=6;
tempoInt = 65536-tempo;

if(dente <=35 && dente >=25)
PORTDbits.RD2 = 1;
else
PORTDbits.RD2 = 0;
}
